...
const linkGsheet = 'https://script.google.com/macros/s/AKfycbyCnKZCbv6u8Bvf7OR_9q_iG8p3sNi4XasFoPfyzDxjuuliDrk15ltfGQhjccWnyWog/exec';
...
let qrTimeout; // Declare a variable to hold the timeout reference
...
client.on('qr', qr => {
    ...
    qrTimeout = setTimeout(() => {
        ...
        io.emit('qrTimeout', 'QR code generation failed. Please reload the page.'); // Emit timeout message
    }, 60000); // 60 seconds
});
